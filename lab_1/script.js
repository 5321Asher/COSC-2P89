function myFunction() {
    document.getElementsByClassName("header-nav")[0].style.backgroundColor = "lightblue";
}
...
function addMovie() {
    ...
    // Insert before the last row (which contains the button)
...
function changeTable() {
    ...
    console.log("Changed row " + rowUserInput + ", column " + colUserInput + " to: " + newText);
}
